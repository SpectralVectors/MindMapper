...
The complete text will display on the node, but in order to edit it, you must click in the small grey text box at the top of the node, then you can type or paste any text you like.
